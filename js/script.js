...
questions:[
     {title:"1. Язык сценариев для придания интерактивности веб-страницам это:",
      chekboxName:["one","two","three"],
      id:["1","2","3"],
      answers:["C++", "JavaScript", "Java"],
      correct:2
      },
     {title:"2. Один из создателей JavaScript это:",
      chekboxName:["one","two","three"],
      id:["4","5","6"],
      answers:["Бьёрн Страуструп", "Джеймс Гослинг", "Брендан Эйх"],
      correct:6
      },
      {title:"3. Что из ниже перечисленного не написано с использованием JavaScript:",
      chekboxName:["one","two","three"],
      id:["7","8","9"],
